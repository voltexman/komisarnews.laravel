            ...
            <div class="col text-center my-5">
                <span class="mb-3">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                        ...
                        <path stroke="#91765a" stroke-linecap="round" d="M15 15.25l-.049-.04A4.631 4.631 0 009 15.25"
                            stroke-width="1.3" style="animation:sad 4s infinite linear" stroke-dasharray="100" />
                    </svg>
                </span>
