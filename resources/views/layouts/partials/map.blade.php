<div class="map-info ms-3 ms-lg-0">
    <p class="mb-1"><small class="active me-1"></small>Регіони в яких скуповуємо</p>
    <p class="m-0"><small class="no-active me-1"></small>Тимчасово не співпрацюємо</p>
</div>
<svg version="1.1" id="Ukraine" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g id="ukraineMap">
        <a id="SevastopolCity" aria-label="Севастополь" target="_new" href="https://en.wikipedia.org/wiki/Sevastopol">
        ...
        <path id="Cherkasy" class="mapBackground"
        ...
        <path class="mapBackground capital"
        ...
        <path id="Poltava" class="mapBackground"
