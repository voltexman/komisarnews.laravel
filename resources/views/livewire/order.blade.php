    ...
    <form wire:submit="save" x-data="{
                ...
                <div
                    ...
                    <span
                        ...
                        <i data-lucide="file-text" class="w-4 h-4"
                           x-bind:class="isActive(1) ? 'text-max-soft block' : 'hidden'"></i>
                        <i data-lucide="check" class="w-4 h-4"
                           x-bind:class="isDone(1) ? 'block text-max-light' : 'hidden'"></i>
                    </span>
                </div>
            ...
            <li class="flex flex-col items-center justify-center flex-1 md:shrink md:basis-0 group gap-x-2 md:flex">
                <div
                    ...
                    <span
                        ...
                        <i data-lucide="file-text" class="w-4 h-4"
                           x-bind:class="isActive(2) ? 'text-max-soft block' : 'hidden'"></i>
                        <i data-lucide="check" class="w-4 h-4"
                           x-bind:class="isDone(2) ? 'block text-max-light' : 'hidden'"></i>
                    </span>
                </div>
                <div class="mt-1 grow md:grow-0">
                    <span class="block text-sm font-semibold text-gray-600">
                ...
                <div
                    ...
                    <span
                        ...
                        <i data-lucide="message-circle" class="w-4 h-4"
                           x-bind:class="isActive(3) ? 'text-max-soft block' : 'hidden'"></i>
                        <i data-lucide="check" class="w-4 h-4"
                           x-bind:class="isDone(3) ? 'block text-max-light' : 'hidden'"></i>
                    </span>
                </div>
                <div class="mt-1 grow md:grow-0">
                    <span class="block text-sm font-semibold text-gray-600">
                ...
                <div
                    ...
                    <span
                        ...
                        <i data-lucide="list-checks" class="w-4 h-4"
                           x-bind:class="isActive(4) ? 'text-max-soft block' : 'hidden'"></i>
                        <i data-lucide="check" class="w-4 h-4"
                           x-bind:class="isDone(4) ? 'block text-max-light' : 'hidden'"></i>
                    </span>
                </div>
                <div class="mt-1 grow md:grow-0">
                    <span class="block text-sm font-semibold text-gray-600">
        ...
        <div class="flex flex-col mt-5">
                ...
                <div x-show="isActive(1)">
                    ...
                    <div class="flex flex-col w-full gap-y-5">
                                ...
                                @foreach($goals as $goal)
                                    <div
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                @click="$wire.set('order.goal', '{{ $goal['option'] }}')"
                        ...
                        <x-input
                            ...
                            icon="user"
                            maxlength="40"
                            class="border bg-max-soft/20 border-max-soft/20"
                ...
                <div x-show="isActive(4)">
                    ...
                    <div class="grid grid-cols-3 gap-5 mt-4 space-y5">
                        ...
                        <div class="flex flex-col text-sm">
                            ...
                            <span class="font-normal"
                                  x-bind:class="{'italic text-gray-500': !$wire.order.age}"
            ...
            <div class="flex justify-between gap-x-2">
                <button x-show="current > 1"
                    ...
                    <i data-lucide="chevron-left" class="w-4 h-4 me-1"></i>
                    Назад
                </button>

                <button type="button"
                        @click="showModal = true"
                        aria-label="Правила заявки"
                    ...
                    <i data-lucide="info" class="w-5 h-5 text-max-light"></i>
                </button>

                <button x-show="current !== total"
                    ...
                    Далі
                    <i data-lucide="chevron-right" class="w-4 h-4 ms-1"></i>
                </button>
                <button x-show="current === total"
                        type="submit"
        ...
        <template x-teleport="body">
            <div x-show="showModal"
                 class="fixed inset-0 z-[90] flex items-center justify-center overflow-auto bg-black bg-opacity-50 backdrop-blur-sm">
                <div x-show="showModal"
                ...
                >
                    <span @click="showModal = false" class="absolute cursor-pointer top-2 right-2">
                    ...
                    <div class="p-4 bg-max-soft/15">
                        <div class="font-semibold uppercase text-max-dark drop-shadow-lg shadow-max-dark">
                            <i data-lucide="file-check" class="inline-flex h-7 w-7"></i>
                            Правила
                        </div>
                    </div>
                    ...
                    <div class="h-full p-4 overflow-hidden">
                        <div
                            ...
                            <i data-lucide="file-text" class="h-14 w-14 float-start me-2"></i>
                    ...
                    <div class="p-2 mt-auto bg-red-500/70">
