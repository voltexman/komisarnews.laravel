    ...
    <form wire:submit="save">
        <div
                ...
                <div class="absolute top-0 left-0 w-full h-full">
                    <div class="flex flex-col items-stretch justify-center h-full text-max-soft" role="status">
                        <div class="self-center text-center">
                            ...
                            <x-button class="mt-10" wire:click='$refresh' wire:loading.attr="disabled"
                                wire:target.except='save'>
                                Новий лист
                                <x-lucide-rotate-ccw class="inline-block w-4 h-4 ms-1" wire:loading.remove />
                                <x-lucide-loader-circle class="hidden w-4 h-4 animate-spin ms-1"
                                    wire:loading.class.remove='hidden' wire:loading.class='inline-block' />
                            </x-button>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-center">
                <x-button type="submit" class="mt-8">Надіслати
