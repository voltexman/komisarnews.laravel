...
window.onload = function () {
    ...
    let uploadZoneIcon = document.querySelector('div#uploadZone i');
    let uploadZoneAddTitle = document.querySelector('div#uploadZone .add-title');
    let uploadZoneAddDescription = document.querySelector('div#uploadZone .add-description div');
